...
stock_list_all = list(stocks['Materials'].dropna())
stock_list=random.sample(stock_list_all, min(len(stock_list_all),80)) # Randomly select stocks to avoid query limit
